...
"""autogenerated by genpy from sophon_robot/Bboxes.msg. Do not edit."""
import codecs
import sys
...
class Bboxes(genpy.Message):
  _md5sum = "bce7b973189104571425eaff14883c6a"
  _type = "sophon_robot/Bboxes"
...
float32  height
float32  conf"""
  __slots__ = ['frame_id','num_object','bboxes']
  _slot_types = ['uint32','uint32','sophon_robot/Bbox[]']
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_2I().pack(_x.frame_id, _x.num_object))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.frame_id, _x.num_object,) = _get_struct_2I().unpack(str[start:end])
      start = end
      end += 4
