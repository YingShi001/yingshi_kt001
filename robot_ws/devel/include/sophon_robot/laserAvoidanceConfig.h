...
#ifndef __sophon_robot__LASERAVOIDANCECONFIG_H__
#define __sophon_robot__LASERAVOIDANCECONFIG_H__
...
namespace sophon_robot
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(laserAvoidanceConfig &config, const laserAvoidanceConfig &max, const laserAvoidanceConfig &min) const override
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const laserAvoidanceConfig &config1, const laserAvoidanceConfig &config2) const override
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, laserAvoidanceConfig &config) const override
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const laserAvoidanceConfig &config) const override
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, laserAvoidanceConfig &config) const override
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const laserAvoidanceConfig &config) const override
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const laserAvoidanceConfig &config, boost::any &val) const override
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, laserAvoidanceConfig &top) const override
      {
        PT* config = boost::any_cast<PT*>(cfg);
