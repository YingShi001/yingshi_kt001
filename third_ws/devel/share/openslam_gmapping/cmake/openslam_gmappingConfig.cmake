...
if("TRUE" STREQUAL "TRUE")
  set(openslam_gmapping_SOURCE_PREFIX /data/third_ws/src/openslam_gmapping)
  set(openslam_gmapping_DEVEL_PREFIX /data/third_ws/devel)
  ...
  set(openslam_gmapping_INSTALL_PREFIX /data/third_ws/install)
...
if(NOT "/data/third_ws/src/openslam_gmapping/include;/data/third_ws/devel/include " STREQUAL " ")
  set(openslam_gmapping_INCLUDE_DIRS "")
  set(_include_dirs "/data/third_ws/src/openslam_gmapping/include;/data/third_ws/devel/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'openslam_gmapping' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/data/third_ws/src/openslam_gmapping/${idir}'.  ${_report}")
    endif()
