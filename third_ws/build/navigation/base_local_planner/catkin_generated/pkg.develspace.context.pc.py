...
PROJECT_PKG_CONFIG_INCLUDE_DIRS = "/data/third_ws/devel/include;/data/third_ws/src/navigation/base_local_planner/include".split(';') if "/data/third_ws/devel/include;/data/third_ws/src/navigation/base_local_planner/include" != "" else []
