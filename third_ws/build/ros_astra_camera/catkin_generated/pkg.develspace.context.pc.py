...
PROJECT_PKG_CONFIG_INCLUDE_DIRS = "/data/third_ws/devel/include;/data/third_ws/src/ros_astra_camera/include".split(';') if "/data/third_ws/devel/include;/data/third_ws/src/ros_astra_camera/include" != "" else []
